...
import BaseRadioToggle from "../BaseRadioToggle.vue";
export default {
    components: { TableBase, InfoBox, BaseRadioToggle },
    props: {
        plugin: {
          type: Object,
          required: true,
    ...
    computed: {
      ...
      ordinalValues() {
        if (this.currentProperty.possibleValues && this.currentProperty.scaleOfMeasure === "ordinal") {
          let ordVals = {};

          Object.entries(this.currentProperty.possibleValues).forEach(([key, def]) => {
